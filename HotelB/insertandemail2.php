...
include './auth.php';
mysqli_query($con,"INSERT INTO `unleashe_hotel`.`guest` 
...
");
$id = mysqli_insert_id($mysqli_query);
mysqli_query($con,"INSERT INTO `unleashe_hotel`.`booking` (`booking_id`, `room_id`, `totalroombook`, `guest_id`, `total_adult`, `total_children`, `checkin_date`, `checkout_date`, `special_requirement`, `payment_status`, `total_amount`, `deposit`, `booking_date`) 
...
$_SESSION['booking_id'] = mysqli_insert_id($mysqli_query);
