...
$r = mysqli_query($con,"UPDATE  `booking` SET  `payment_status` =  'confirmed' WHERE  `booking`.`booking_id` = ".$id.";");
echo mysqli_error($con);
$result = mysqli_query($con,"select * from booking where booking_id = '".$id."';");
