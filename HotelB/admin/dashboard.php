			...
			<div class="container-fluid">
			 <h4 class="sub-header">Dashboard</h4>
				<div class="row">	
					...
					$re2 = mysqli_query($con,"select count(booking_id) as total_row from booking WHERE payment_status like 'pend%';");
					$re3 = mysqli_query($con,"select count(booking_id) as total_row from booking WHERE payment_status like 'conf%';");
					 ...
					 <hr>       <div class="col-xs-12 "  >
							  ...
							  <div class="table-responsive">
								<table class="table table-striped">
								  ...
								  <tbody id="info1"  >
				<?php include './auth.php';
					$re = mysqli_query($con,"select * from booking WHERE payment_status like 'pend%';");
					if(mysqli_num_rows($re) > 0){
								while ($row = mysqli_fetch_array($re) ){
											print "<tr style=\"\">		 <td>".$row['booking_id']."</td>\n";
											print "                  <td>".$row['checkin_date']."</td>\n";
					      ...
					      <hr>  <div class="col-xs-12 "  >
							  ...
							  <div class="table-responsive">
								<table class="table table-striped">
								  ...
								  <tbody id="info2"  >
				<?php include './auth.php';
					$re = mysqli_query($con,"select * from booking WHERE payment_status like 'conf%';");
					if(mysqli_num_rows($re) > 0){
								while ($row = mysqli_fetch_array($re) ){
											print "<tr style=\"\">		 <td>".$row['booking_id']."</td>\n";
											print "                  <td>".$row['checkin_date']."</td>\n";
